abstract class Abstract7{
    ...
    void meth2(){
        System.out.println("I am the method 2 of abstract7 class.");
    }
    abstract void meth3();
    abstract void meth4();
...
abstract class Abstract8 extends Abstract7{
    void meth2(){
        super.meth2();
        System.out.println("I am the method 2 of the abstract8 class.");
    }
}



public class PV_06_AbstractKeyword extends Abstract8{
    void meth4(){
    ...
    public static void main(String argsp[]){
        Abstract8 obj = new PV_06_AbstractKeyword();
        obj.meth1();
        obj.meth2();
        obj.meth3();
        obj.meth4();
